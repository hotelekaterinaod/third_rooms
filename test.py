...
def init_room():
    ...
    pin_structure = {
        0: None,
        1: PinController(1, f_switch_br),
        7: PinController(7, f_window2),
        8: PinController(8, f_fire_detector4),
        10: PinController(10, f_safe),
        12: PinController(12, f_switch_bl),
        13: PinController(13, f_window3),
        16: PinController(16, f_switch_main),
        17: PinController(17, f_energy_sensor),
        18: PinController(18, f_using_key),
        19: PinController(19, f_fire_detector2),
        20: PinController(20, f_window1),
        21: PinController(21, f_flooding_sensor),
        22: PinController(22, f_card_key),
        23: PinController(23, f_lock_door_from_inside),
        24: PinController(24, f_lock_latch),
        25: PinController(25, f_fire_detector1),
        26: PinController(26, f_fire_detector3),
        27: PinController(27, f_circuit_breaker),
    }
